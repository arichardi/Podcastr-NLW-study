        ...
        {lastestEpisodes.map( (episode, index) => {
          return (
            <li key={episode.id}>
              ...
              <button type='button' className={styles.buttonPlay} onClick={ () => playList(episodeList, index) } >
         ...
         {allEpisodes.map( (episode, index) => {
           return (
             <tr key={episode.id} >
               ...
               <td>
                 <button type='button' className={styles.buttonPlayM} onClick={ () => playList(episodeList, index + lastestEpisodes.length)}>
