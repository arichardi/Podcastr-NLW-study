...
### React ressources never used by me before

Usecontext e createContext to transit values between my application
...
The place used to centralized the data between the components.

You need use the *createContext* of react to create the interchangeable state and
import on app file, as a provider *context.provider*, informing a value
...
You can access the context throw the useContext

`Player`
All the data related with the communication between the page and the player.
